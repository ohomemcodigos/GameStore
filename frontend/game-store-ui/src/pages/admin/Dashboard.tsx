  ...
  return (
    <div style={{ padding: '2rem', background: '#1a1a1a', minHeight: '100vh', color: 'white' }}>
      <div style={{ maxWidth: '1000px', margin: '0 auto' }}>
        ...
        {/* Tabela */}
        <table style={{ width: '100%', borderCollapse: 'collapse', background: '#333', borderRadius: '8px', overflow: 'hidden' }}>
            <thead>
            ...
            <tbody>
                {games.map(game => (
                    <tr key={game.id} style={{ borderBottom: '1px solid #555' }}>
                        ...
                        <td style={{ padding: '1rem' }}>R$ {Number(game.price).toFixed(2)}</td>
                        <td style={{ padding: '1rem', display: 'flex', gap: '10px' }}>
                            
                            <button 
                                onClick={() => handleEditGame(game)} 
                                style={{ background: '#f39c12', border: 'none', padding: '5px 10px', borderRadius: '4px', cursor: 'pointer', color: 'white' }}
                            >
                                Editar
                            </button>
                            ...
                            <button 
                                ...
                                style={{ background: '#c0392b', border: 'none', padding: '5px 10px', borderRadius: '4px', cursor: 'pointer', color: 'white' }}
                            >
                                Excluir
                            </button>
                        </td>
